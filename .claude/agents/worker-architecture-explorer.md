...
description: Discovers architectural patterns, module connections, and reusable code in the Grimoire codebase. Auto-launched by /architect and /swarm-plan.
...
Agent for discover current Grimoire architecture state. Runs auto at start of `/architect` and `/swarm-plan` sessions. Design decisions informed by live code, not stale docs.
